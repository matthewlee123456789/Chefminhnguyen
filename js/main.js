...
var reduce = window.matchMedia('(prefers-reduced-motion: reduce)').matches;
  var DICT = {
    ...
    'cui.d1n':['Gỏi tôm sú biển tái húng quế','Seared tiger prawn with Thai basil'],'cui.d1s':['Sốt nước mắm đậu phộng · form bọt trái giác','Peanut fish-sauce dressing · wild grape foam'],
    'cui.d2n':['Nọng heo đen Hà Giang sous-vide nướng muối ớt','Hà Giang black pork jowl, sous-vide then chilli-salt grilled'],'cui.d2s':['Rau củ ủ bơ · ớt nướng salsa · sốt mù tạc Pháp mật ong bạc hà','Butter-braised vegetables · grilled chilli salsa · Dijon and mint-honey sauce'],
    ...
    'cui.d4n':['Gà đen H’Mông cuộn bắp non nướng xông gỗ quế','H’Mông black chicken rolled with young corn, cinnamon-wood smoked'],'cui.d4s':['Sốt chẩm chéo hạt dổi · măng rừng nướng · nếp nương hấp lá dứa','Chẩm chéo with dổi seed · grilled wild bamboo · pandan-steamed upland rice'],
    ...
    'pil.p1a':['Khai giảng liên tục các khoá 1 kèm 1 VIP','Rolling one-to-one VIP courses'],'pil.p1b':['Thiết kế menu cá nhân hoá','Personalised menu design'],'pil.p1c':['Lớp chuyên đề món Việt – Âu trong ngày','One-day Vietnamese–European workshops'],
    ...
    'pil.p2a':['Hợp tác quảng bá cùng nhãn hàng','Brand promotion partnerships'],'pil.p2b':['KOL ngành ẩm thực','Food-industry KOL'],'pil.p2c':['Sản xuất video, hình ảnh quảng bá sản phẩm','Product video and photo production'],
