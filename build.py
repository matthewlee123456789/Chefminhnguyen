...
<link rel="preload" as="image" href="{up}assets/hero-poster.jpg" fetchpriority="high">
<link rel="stylesheet" href="{up}css/style.css">
<link rel="stylesheet" href="{up}css/motion.css">
<link rel="stylesheet" href="{up}css/ads.css">
</head>
<body>
{SEAL_DEFS}
'''
...
<script src="{'../' * depth}js/icons.js"></script>
<script src="{'../' * depth}js/i18n-auto.js"></script>
<script src="{'../' * depth}js/main.js"></script>
<script src="{'../' * depth}js/motion.js"></script>
<script src="{'../' * depth}js/ads.js"></script>
</body>
</html>
'''
...
BIO = [
    ...
    ('2015', 'award',
     ('Huy chương vàng cuộc thi Đầu bếp Việt Nam Tài năng, phần thi set menu món Việt. Cùng năm đạt huy chương bạc giải Đầu bếp trẻ Việt Nam Tài năng do hiệp hội đầu bếp thế giới tổ chức.',
      'Gold medal at Vietnam Talented Chef for the Vietnamese set-menu round, plus silver at the Young Talented Chef award organised by the world chefs association.')),
    ('2016 – 2017', 'world',
...
DISHES = [
    ('1', 'mon-01-trai-giac.jpg',  '01', 'Gỏi tôm sú biển tái húng quế',
     'Sốt nước mắm đậu phộng · form bọt trái giác', 'dish--a'),
    ('2', 'mon-02-goi-tom-su.jpg', '02', 'Nọng heo đen Hà Giang sous-vide nướng muối ớt',
     'Rau củ ủ bơ · ớt nướng salsa · sốt mù tạc Pháp mật ong bạc hà', 'dish--b'),
  ...
  <div class="wrap">
    <div class="craft reveal">
      ...
      <div>
        ...
        <p class="lead" data-i18n="craft.lead">Chef Minh Nguyễn trong năm 2026 nổi bật với vai trò Nhà sáng lập kiêm CEO của cộng đồng Vietchefs Worldwide (VCW) và gia nhập hiệp hội International Chefs Sans Frontières (CSFint). Anh cũng tích cực đồng hành cùng các đấu trường ẩm thực lớn như <a href="https://www.facebook.com/Minhnguyensg0110/" target="_blank" rel="noopener">Top Chef Việt Nam 2026</a>, đẩy mạnh các giá trị cốt lõi của ẩm thực Việt Nam trước thềm APEC 2027, lan toả văn hoá ẩm thực thuần vị và kết nối thị trường.</p>
        <div class="stats">
          ...
          <div class="stat"><b>2 × HCV</b><span data-i18n="craft.s3s">Đầu bếp Việt Nam Tài năng 2015 &amp; 2022</span></div>
        </div>
...
POSTS = [
    ('blog/sous-vide.html', 'mon-02-goi-tom-su.jpg',
    ...
    ('blog/dry-aging.html', 'mon-03-ca-tuyet.jpg',
    ...
    ('blog/nuoc-dung.html', 'mon-04-nong-heo.jpg',
...
<section class="band band--dark">
  <div class="wrap">
    ...
    <h2 class="h-2" style="margin-bottom:34px">Xem Chef Minh làm nghề.</h2>
''' + video_grid() + '''

    <p class="eyebrow" style="margin-top:72px">Hình ảnh</p>
''' + media_grid() + '''
